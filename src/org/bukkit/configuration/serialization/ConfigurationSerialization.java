...
public class ConfigurationSerialization {
    ...
    protected Method getMethod(String name, boolean isStatic) {
        try {
            ...
            if (isStatic(method.getModifiers()) != isStatic) {
                return null;
            }
    ...
    protected ConfigurationSerializable deserializeViaMethod(Method method, Map<String, ?> args) {
        try {
            ...
            if (result == null) {
                getLogger(ConfigurationSerialization.class.getName()).log(SEVERE, "Could not call method '" + method.toString() + "' of " + clazz + " for deserialization: method returned null");
            } else {
                return result;
            }
        } catch (Throwable ex) {
            getLogger(ConfigurationSerialization.class.getName()).log(SEVERE,
